(function(){
	...
	function create(){
		...
		leftArrow = game.add.button(this.game.height/2 - 150, this.game.height - 55, 'arrowButton');
		rightArrow = game.add.button(this.game.height/2 - 50, this.game.height - 55, 'arrowButton');
		actionButton = game.add.button(this.game.height/2 + 150, this.game.height - 55, 'actionButton');
